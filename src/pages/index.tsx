  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing: Revolutionizing mobility by connecting individual customers with nearby cars, managed seamlessly by our dedicated operations staff."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing: Revolutionizing mobility by connecting individual customers with nearby cars, managed seamlessly by our dedicated operations staff.`}
            </Text>
            <Box
